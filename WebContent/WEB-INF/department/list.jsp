...
<body>
	<div class="container " style="margin-top: 20px">
		...
		<div class="row">
			...
			<div class="col-sm-9">
				<div class="row"></div>
				<a href="${pageContext.request.contextPath}/department?cmd=input"
					class="btn btn-success">添加</a> <a
					href="${pageContext.request.contextPath}/department?cmd=generate"
					class="btn btn-success">导出数据</a>
				<form id="searchForm"
					...
					<c:forEach items="${pageInfo.data}" var="entity" varStatus="vs">
						<tr>
							...
							<td><a class="btn btn-info btn-xs"
								href="${pageContext.request.contextPath}/department?cmd=input&id=${entity.id}">
									<span class="glyphicon glyphicon-pencil"></span>编辑
							</a> <a
								href="${pageContext.request.contextPath}/department?cmd=delete&id=${entity.id}"
